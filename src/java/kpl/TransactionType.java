    ...
    public static abstract class ColoredCoins extends TransactionType {
        ...
        public static final TransactionType ASSET_TRANSFER = new ColoredCoins() {
            ...
            void validateAttachment(Transaction transaction) throws KplException.ValidationException {
                ...
                if (Snapshot.ardorSnapshotAssets.contains(attachment.getAssetId()) && Kpl.getBlockchain().getHeight() >= Kpl.getHardForkHeight()) {
                    throw new KplException.NotCurrentlyValidException("Asset transfer of ARDR asset not allowed after height " + Kpl.getHardForkHeight());
                }
            }
        ...
        public static final TransactionType ASSET_DELETE = new ColoredCoins() {
            ...
            void validateAttachment(Transaction transaction) throws KplException.ValidationException {
                ...
                if (Snapshot.ardorSnapshotAssets.contains(attachment.getAssetId()) && Kpl.getBlockchain().getHeight() >= Kpl.getHardForkHeight()) {
                    throw new KplException.NotCurrentlyValidException("Asset delete of ARDR asset not allowed after height " + Kpl.getHardForkHeight());
                }
            }
        ...
        abstract static class ColoredCoinsOrderPlacement extends ColoredCoins {
            ...
            final void validateAttachment(Transaction transaction) throws KplException.ValidationException {
                ...
                if (Snapshot.ardorSnapshotAssets.contains(attachment.getAssetId()) && Kpl.getBlockchain().getHeight() >= Kpl.getHardForkHeight()) {
                    throw new KplException.NotCurrentlyValidException("Asset order placements for ARDR asset not allowed after height " + Kpl.getHardForkHeight());
                }
            }
