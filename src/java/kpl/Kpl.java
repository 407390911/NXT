...
public final class Kpl {
    ...
    public static final String KPL_INSTALLER_PROPERTIES = "kpl-installer.properties";
    ...
    static {
        ...
        System.out.println(Kpl.defaultProperties.getProperty("kpl.version"));
    ...
    static {
        loadProperties(properties, KPL_INSTALLER_PROPERTIES, true);
    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("Distributed under the Jelurida Public License version 1.0 for the Kpl Public Blockchain Platform, with ABSOLUTELY NO WARRANTY.");
