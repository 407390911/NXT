...
public final class Constants {
    ...
    public static final String customLoginWarning = Kpl.getStringProperty("kpl.customLoginWarning", null, false, "UTF-8");
    ...
    public static final int BATCH_COMMIT_SIZE = Kpl.getIntProperty("kpl.batchCommitSize", Integer.MAX_VALUE);
    ...
    public static final int MAX_DIVIDEND_PAYMENT_ROLLBACK = 50000;
    ...
    public static final long MIN_HUB_EFFECTIVE_BALANCE = 1;
    ...
    public static final int SHUFFLING_BLOCK = isTestnet ? 483000 : 483000;
    ...
    // LAST_KNOWN_BLOCK must also be set in html/www/js/krs.constants.js
