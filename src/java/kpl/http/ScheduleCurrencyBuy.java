...
import kpl.TransactionScheduler;
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws KplException {
        ...
        try {
            ...
            if (transactionBytes == null && transactionJSON == null) {
                ...
                transaction = Kpl.newTransactionBuilder((JSONObject) response.get("transactionJSON")).build();
            } else {
            ...
            try {
                ...
                try (DbIterator<? extends Transaction> unconfirmedTransactions = Kpl.getTransactionProcessor().getAllUnconfirmedTransactions()) {
