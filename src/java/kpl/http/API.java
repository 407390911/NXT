...
import static kpl.http.JSONResponses.MISSING_ADMIN_PASSWORD;
import static kpl.http.JSONResponses.INCORRECT_ADMIN_PASSWORD;
import static kpl.http.JSONResponses.LOCKED_ADMIN_PASSWORD;
...
public final class API {
    ...
    public static final int apiServerIdleTimeout = Kpl.getIntProperty("kpl.apiServerIdleTimeout");
    public static final boolean apiServerCORS = Kpl.getBooleanProperty("kpl.apiServerCORS");
    private static final String forwardedForHeader = Kpl.getStringProperty("kpl.forwardedForHeader");
    ...
    static {
        List<String> disabled = new ArrayList<>(Kpl.getStringListProperty("kpl.disabledAPIs"));
        ...
        if (enableAPIServer) {
            ...
            if (enableSSL) {
                ...
                sslContextFactory.setKeyStoreType(Kpl.getStringProperty("kpl.keyStoreType"));
            ...
            servletHolder = apiHandler.addServlet(APIProxyServlet.class, "/kpl-proxy");
            ...
            if (!Kpl.getBooleanProperty("kpl.enableAPIServerGZIPFilter", isOpenAPI)) {
                gzipHandler.setExcludedPaths("/kpl", "/kpl-proxy");
            }
