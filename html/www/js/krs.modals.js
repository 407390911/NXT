...
var KRS = (function(KRS, $, undefined) {
	...
	KRS.showModalError = function(errorMessage, $modal) {
		...
		$modal.find(".error_message").html(KRS.escapeRespStr(errorMessage)).show();
		$btn.button("reset");
		$modal.modal("unlock");
	};
	...
	KRS.isShowFakeWarning = function() {
		if (KRS.settings.fake_entity_warning != "1") {
			return false;
		}
		return !isFakeWarningDisplayed;
    };

	KRS.composeFakeWarning = function (entity, id) {
