...
var KRS = (function (KRS, $) {
	...
	KRS.getPublicKey = function(id, isAccountId) {
		if (isAccountId) {
            var publicKey = "";
	...
	KRS.getAccountId = function(secretPhrase, isRsFormat) {
		return KRS.getAccountIdFromPublicKey(KRS.getPublicKey(converters.stringToHexString(secretPhrase)), isRsFormat);
	};

	KRS.getAccountIdFromPublicKey = function(publicKey, isRsFormat) {
		...
		if (isRsFormat) {
			return KRS.convertNumericToRSAccountFormat(accountId);
		} else {
			return accountId;
		}
	};
    ...
    KRS.encryptMessage = function(KRS, text, senderSecretPhrase, recipientPublicKey, isMessageToSelf) {
        var encrypted = KRS.encryptNote(text, {
