/******************************************************************************
 * Copyright © 2013-2016 The krs Core Developers.                             *
 ...
 * no part of the krs software, including this file, may be copied, modified, *
...
QUnit.test("generatePublicKey", function (assert) {
    assert.throws(function() { KRS.generatePublicKey("") }, { message: "Can't generate public key without the user's password." }, "empty.public.key");
