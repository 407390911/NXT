...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(KRS.getAccountLink({ entityRS: "KPL-XK4R-7VJU-6EQG-7R335" }, "entity", "KPL-XK4R-7VJU-6EQG-7R335", "account"), "<a href='#' data-user='KPL-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>Account</a>", "force.account.name");
