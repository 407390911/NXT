...
var KRS = (function (KRS, $, undefined) {
    ...
    KRS.getRandomPermutation = function(array) {
    ...
    KRS.printPaperWallet = function(passphrase) {
        var $pageHeader = $("<h2 data-i18n='kpl_ardor_paper_wallet'>KPL and Ardor Paper Wallet</h2>");
        var $passphraseHeader = $("<h3 data-i18n='passphrase'>Passphrase</h3>");
        var $passphraseText = $("<div></div>");
        $passphraseText.text(passphrase);
        var passphraseImg = KRS.generateQRCode(null, passphrase, 2, 4);
        $(passphraseImg).load(function() {
            var account = KRS.getAccountId(passphrase, true);
            var $accountHeader = $("<h3 data-i18n='account'>Account</h3>");
            var $accountText = $("<div></div>");
            $accountText.html(account);
            var accountImg = KRS.generateQRCode(null, account, 2, 4);
