const options = {
    url: "http://localhost:6876", // URL of KPL remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the KPL client was note designed with modularity in mind there we have
            ...
            // Now load some KPL specific libraries into the global scope
            global.KplAddress = require('./util/kpladdress');
            ...
            // however the KPL client relies on a global browser scope which defines the KRS object
            // The idea here is to gradually compose the KRS object by adding functions from each
            ...
            global.client = Object.assign(client, require('./krs.encryption'));
            global.client = Object.assign(client, require('./krs.feature.detection'));
            global.client = Object.assign(client, require('./krs.transactions.types'));
            global.client = Object.assign(client, require('./krs.constants'));
            global.client = Object.assign(client, require('./krs.console'));
            global.client = Object.assign(client, require('./krs.util'));
            ...
            global.client = Object.assign(client, require('./krs'));
            client.accountInfo = {};
            global.client = Object.assign(client, require('./krs.server'));
            global.client = Object.assign(client, require('./krs.constants'));
